...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // color of gauge title
    titleFontFamily: kvLookup('titleFontFamily', config, dataset, "Arial"),
    ...
    valueFontColor: kvLookup('valueFontColor', config, dataset, "#000000"),

    // valueFontFamily : string
    // color of label showing current value
    valueFontFamily: kvLookup('valueFontFamily', config, dataset, "Arial", "#000000"),
